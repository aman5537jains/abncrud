...
<form style="margin-top:10px" class="validate form-horizontal" method="GET" action="" enctype="multipart/form-data">
  ...
  <div class="form-group showFormGroup showFormGroup-01 ps-15px mb-0">
      ...
      <div class="showFormGroup-input paglists">
          {!! \Aman5537jains\AbnCmsCRUD\Lib\Form::select('per_page',$per_page_arr, $per_page, [ 'class'=>'form-control','id'=>'show','title'=>'Show entries',"attr"=>[
      ...
      <div class="entrylsit">
       ...
       {!!  \Aman5537jains\AbnCmsCRUD\Lib\Form::text('search[value]', request()->input("search.value",""), [ "style"=>"float:right;width:240px",'class'=>'dForm-control','id'=>'show','placeholder'=>'Type Keyword and Enter','onchange'=>'this.form.submit()'])  !!}
  </div>
  </div>
   </div>
